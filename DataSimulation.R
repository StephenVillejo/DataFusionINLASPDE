...
Data_simulation = function(scenario_n,
  ...
  weights_grid_areas_intersection <- compute.intersections(res_pred_grid = res_pred_grid, compute_Y_Poisson = compute_Y_Poisson)
  weights_points_areas_inside_closest <- compute.predpoints(res_pred_grid = res_pred_grid, compute_Y_Poisson = compute_Y_Poisson)
